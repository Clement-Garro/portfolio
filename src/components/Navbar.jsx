...
const Navbar = () => {
    return (
        <header className="header">
            ...
            <nav className="flex lg:gap-7 font-normal items-center justify-center lg:font-bold shadow-md bg-white rounded-3xl lg:px-5 lg:py-3 text-sm lg:text-xl px-2 py-2">
                <NavLink
                    key="about"
                    to="/about"
                    className={({ isActive }) =>
